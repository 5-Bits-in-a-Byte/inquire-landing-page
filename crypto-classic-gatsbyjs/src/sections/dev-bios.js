...
const BIOS_DATA = [
  ...
  },
  {
    ...
    socials: [
      ...
      "mailto:brianfunnarson14@gmail.com",
    ],
    bgColor: "#f8f8f8",
    fontColor: "#162b55",
  },
                ...
                >
                  <Box sx={styles.imageWrap}>
                    <Img
                      ...
                      alt="icon image"
                      style={{
                        boxShadow: `10px 10px 15px rgba(0, 0, 0, 0.25)`,
                        width: `150px`,
                        height: `auto`,
                        borderRadius: `50%`,
                      }}
                  ...
                  <Heading as="h3" style={{ color: `#162b55` }}>
                    {name}
                  </Heading>
                  <Heading
                    as="h4"
                    style={{ color: `#4a86fa`, fontSize: `18px` }}
                  >
                    Project Role: <br /> {roleTitle}
                  </Heading>
                  <Text as="p" style={{ color: `#162b55` }}>
                    {info}
                  </Text>
                  <div
                    style={{
